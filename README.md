...
![CodeQL](https://github.com/kollorg/quia-iusto/workflows/CodeQL/badge.svg)
![CI test](https://github.com/kollorg/quia-iusto/workflows/ci-test/badge.svg)
[![Coverage Status](https://coveralls.io/repos/github/kollorg/quia-iusto/badge.svg?branch=main)](https://coveralls.io/github/kollorg/quia-iusto?branch=main)
...
```bash
npm i @kollorg/quia-iusto

# pnpm
pnpm i @kollorg/quia-iusto

# yarn
yarn add @kollorg/quia-iusto
```

```ts
// es6 module
import { extract } from '@kollorg/quia-iusto'
```

### Deno

```ts
import { extract } from 'https://esm.sh/@kollorg/quia-iusto'

// deno > 1.28
import { extract } from 'npm:@kollorg/quia-iusto'
```
...
Passing requests to proxy is useful while running `@kollorg/quia-iusto` on browser. View [examples/browser-article-parser](examples/browser-article-parser) as reference example.
...
```js
import { extractFromHtml } from '@kollorg/quia-iusto'
...
In `@kollorg/quia-iusto`, `transformation` is an object with the following properties:
...
```ts
import { addTransformations } from '@kollorg/quia-iusto'
...
```js
import { removeTransformations } from '@kollorg/quia-iusto'
...
In this scenario, `@kollorg/quia-iusto` will execute both transformations, one by one:
...
`@kollorg/quia-iusto` uses [sanitize-html](https://github.com/apostrophecms/sanitize-html) to make a clean sweep of HTML content.
...
There are 2 methods to access and modify these options in `@kollorg/quia-iusto`.
...
```bash
git clone https://github.com/kollorg/quia-iusto.git
